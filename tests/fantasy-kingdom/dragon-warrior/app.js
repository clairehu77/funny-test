...
function calculateScores() {
  ...
  state.answers.forEach((answer, questionIndex) => {
    const weight = questionIndex === 11 ? 0.45 : 1;
...
function submit() {
  ...
  rarityValue.textContent = `约 ${meta.percent}% 的勇士会抵达这里`;
...
document.getElementById("dragonEntryBtn").addEventListener("click", () => showView("intro"));
